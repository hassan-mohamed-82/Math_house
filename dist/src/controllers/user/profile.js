...
const updateMyProfile = async (req, res) => {
    ...
    if (grade) {
        const [existingGrade] = await connection_1.db
            .select()
            .from(schema_1.grade)
            .where((0, drizzle_orm_1.and)((0, drizzle_orm_1.eq)(schema_1.grade.id, grade), (0, drizzle_orm_1.eq)(schema_1.grade.categoryId, existingStudent.category)));
        if (!existingGrade) {
            throw new Errors_1.BadRequest("Grade not found or does not belong to your category");
        }
