...
const getAllQuestions = async (req, res) => {
    ...
    const conditions = [
        ...
        lessonId ? (0, drizzle_orm_1.eq)(schema_1.questions.lessonId, lessonId) : undefined,
        chapterId ? (0, drizzle_orm_1.eq)(schema_1.lessons.chapterId, chapterId) : undefined,
        categoryId ? (0, drizzle_orm_1.eq)(schema_1.lessons.categoryId, categoryId) : undefined,
        semesterId ? (0, drizzle_orm_1.eq)(schema_1.chapters.semesterId, semesterId) : undefined,
    ].filter(Boolean);
    ...
    const [totalQueries] = await connection_1.db.select({ count: (0, drizzle_orm_1.count)() })
        ...
        .leftJoin(schema_1.chapters, (0, drizzle_orm_1.eq)(schema_1.chapters.id, schema_1.lessons.chapterId))
        .leftJoin(schema_1.semesters, (0, drizzle_orm_1.eq)(schema_1.semesters.id, schema_1.chapters.semesterId))
    ...
    const Allquestions = await connection_1.db.select({
        ...
        .leftJoin(schema_1.chapters, (0, drizzle_orm_1.eq)(schema_1.chapters.id, schema_1.lessons.chapterId))
        .leftJoin(schema_1.semesters, (0, drizzle_orm_1.eq)(schema_1.semesters.id, schema_1.chapters.semesterId))
        .leftJoin(schema_1.category, (0, drizzle_orm_1.eq)(schema_1.category.id, schema_1.lessons.categoryId))
        .where(finalCondition)
        .limit(limit)
        .offset(offset)
