...
const getSemesters = async (req, res) => {
    ...
    }).from(semester_1.semesters).innerJoin(courses_1.courses, (0, drizzle_orm_1.eq)(courses_1.courses.id, semester_1.semesters.courseId));
...
const getSemesterbyId = async (req, res) => {
    ...
    }).from(semester_1.semesters).innerJoin(courses_1.courses, (0, drizzle_orm_1.eq)(courses_1.courses.id, semester_1.semesters.courseId)).where((0, drizzle_orm_1.eq)(semester_1.semesters.id, id));
