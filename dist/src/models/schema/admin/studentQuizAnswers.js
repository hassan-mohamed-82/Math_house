...
exports.studentQuizAnswers = void 0;
const mysql_core_1 = require("drizzle-orm/mysql-core");
const drizzle_orm_1 = require("drizzle-orm");
const quizAttempts_1 = require("./quizAttempts");
const questions_1 = require("./questions");
exports.studentQuizAnswers = (0, mysql_core_1.mysqlTable)("student_quiz_answers", {
    id: (0, mysql_core_1.char)("id", { length: 255 }).primaryKey().notNull().default((0, drizzle_orm_1.sql) `(uuid())`),
    attemptId: (0, mysql_core_1.char)("attempt_id", { length: 255 }).notNull().references(() => quizAttempts_1.quizAttempts.id, { onDelete: "cascade" }),
