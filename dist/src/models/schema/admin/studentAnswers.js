...
exports.studentAnswers = (0, mysql_core_1.mysqlTable)("student_answers", {
    ...
    attemptId: (0, mysql_core_1.char)("attempt_id", { length: 255 }).notNull().references(() => examAttempts_1.examAttempts.id),
    questionId: (0, mysql_core_1.char)("question_id", { length: 255 }).notNull().references(() => questions_1.questions.id),
    selectedOptionId: (0, mysql_core_1.char)("selected_option_id", { length: 255 }).references(() => questions_1.questionOptions.id),
