...
exports.questions = (0, mysql_core_1.mysqlTable)("questions", {
    ...
    questionType: (0, mysql_core_1.mysqlEnum)("questionType", ["Trail", "Extra", "Parallel"]).notNull(),
    // Linking
    ...
    sectionId: (0, mysql_core_1.char)("section_id", { length: 255 }).references(() => sections_1.Sections.id, { onDelete: "cascade" }),
    codeId: (0, mysql_core_1.char)("code_id", { length: 255 }).references(() => examCodes_1.examCodes.id, { onDelete: "cascade" }),
...
exports.questionAnswers = (0, mysql_core_1.mysqlTable)("question_answers", {
    ...
    image: (0, mysql_core_1.varchar)("answer_image", { length: 255 }),
    text: (0, mysql_core_1.text)("answer_text"),
    createdAt: (0, mysql_core_1.timestamp)("created_at").defaultNow(),
    updatedAt: (0, mysql_core_1.timestamp)("updated_at").defaultNow().onUpdateNow(),
});
