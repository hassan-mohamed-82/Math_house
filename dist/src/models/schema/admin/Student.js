...
exports.Student = (0, mysql_core_1.mysqlTable)("student", {
    ...
    category: (0, mysql_core_1.char)("category", { length: 36 }).notNull().references(() => category_1.category.id, { onDelete: "cascade" }),
    grade: (0, mysql_core_1.char)("grade", { length: 36 }).notNull().references(() => grade_1.grade.id, { onDelete: "cascade" }),
