...
exports.enrolledItems = (0, mysql_core_1.mysqlTable)("enrolledItems", {
    ...
    courseId: (0, mysql_core_1.char)("courseId", { length: 255 }).references(() => courses_1.courses.id, { onDelete: "cascade" }),
    semesterId: (0, mysql_core_1.char)("semesterId", { length: 255 }).references(() => semester_1.semesters.id, { onDelete: "cascade" }),
    chapterId: (0, mysql_core_1.char)("chapterId", { length: 255 }).references(() => chapters_1.chapters.id, { onDelete: "cascade" }),
    lessonId: (0, mysql_core_1.char)("lessonId", { length: 255 }).references(() => lessons_1.lessons.id, { onDelete: "cascade" }),
    paymentId: (0, mysql_core_1.char)("paymentId", { length: 255 }).references(() => payment_1.payment.id, { onDelete: "cascade" }),
    priceId: (0, mysql_core_1.char)("priceId", { length: 36 }).references(() => prices_1.prices.id, { onDelete: "cascade" }),
